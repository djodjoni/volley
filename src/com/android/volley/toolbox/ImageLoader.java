...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        if (cachedBitmap != null) {
            ...
            if (cachedBitmap.getWidth() > maxWidth ||
                ...
                container.scaleState = ImageRequest.SCALESTATE_TO_LARGE;
            } else if (cachedBitmap.getWidth() == maxWidth &&
                    cachedBitmap.getHeight() == maxHeight) {
                container.scaleState = ImageRequest.SCALESTATE_JUST_RIGHT;
            } else if (cachedBitmap.getWidth() < maxWidth &&
                    cachedBitmap.getHeight() < maxHeight) {
                container.scaleState = ImageRequest.SCALESTATE_WIDTH_AND_HEIGHT_TO_SMALL;
            } else if (cachedBitmap.getWidth() < maxWidth ||
                    cachedBitmap.getHeight() < maxHeight) {
                container.scaleState = ImageRequest.SCALESTATE_WIDTH_OR_HEIGHT_TO_SMALL;
            }
    ...
    public class ImageContainer {
        ...
        private Bitmap getBitmapWithDebugInfo() {
            ...
            // draw scale state
            switch (scaleState) {
                case ImageRequest.SCALESTATE_WIDTH_AND_HEIGHT_TO_SMALL:
                    paint.setColor(Color.RED);
                    break;
                case ImageRequest.SCALESTATE_WIDTH_OR_HEIGHT_TO_SMALL:
                    paint.setColor(Color.YELLOW);
                    break;
