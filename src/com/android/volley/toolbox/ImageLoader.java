...
public class ImageLoader {
     ...
     *
     * 2. After a network response returns...
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        final ImageContainer bitmapContainer =
                new ImageContainer(null, requestUrl, cacheKey, imageListener);

        // Update the caller to let them know that they should use the default bitmap.
        imageListener.onResponse(bitmapContainer, true);
    ...
    private class RequestListenerWrapper {
         ...
         */
        public RequestListenerWrapper(Request<?> request, ImageContainer container) {
            mRequest = request;
            ...
            mRunnable = new Runnable() {
                ...
                public void run() {
                    for (RequestListenerWrapper wrapper : mBatchedResponses.values()) {
                        for (ImageContainer container : wrapper.mHandlers) {
                            // If one of the callers in the wrapper canceled the request
                            ...
                            if (error == null) {
                                container.mBitmap = wrapper.mResponseBitmap;
